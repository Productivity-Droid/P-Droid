package com.techov8.p_droid.AUTO_REPLY.service;
...
import com.techov8.p_droid.AUTO_REPLY.receivers.NotificationServiceRestartReceiver;
...
//        super.onStartCommand(intent, flags, startId);
    ...
    public void tryReconnectService() {
        if(PreferencesManager.getPreferencesInstance(getApplicationContext()).isServiceEnabled()
            ...
            broadcastIntent.setAction("p_droid-RestartService-Broadcast");
